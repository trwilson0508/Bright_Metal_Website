...
function changeProblem(){
    ...
    // document.getElementById("numeral_a").innerHTML = "";
    // document.getElementById("numeral_b").innerHTML = "";
    let numeral_a = Math.floor(Math.random() * 12);
    let numeral_b = Math.floor(Math.random() * 12);
